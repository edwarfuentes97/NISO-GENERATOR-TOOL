// ============================================================
// PROMOCIONALES — cuadrados 1080×1080 o verticales 1080×1920
// Estilo del manual: foto full + monograma N centrado arriba.
// Uso: npm run promos
// ============================================================
...
// ------------------ CONFIGURACIÓN ------------------
const CONFIG = {
  carpetaSalida: 'promocionales-nuevos',

  promos: [
    // --- Promo cuadrada (estilo "Promo Finde") ---
    {
      formato: 'cuadrado',
      nombre: '01-ejemplo-cuadrado',
      img: '1.jpg',
      // pos: 'center 40%',
      kicker: 'Pedidos del fin de semana',
      titulo: 'Asegura<br>tu finde',
      sub: 'Encarga con anticipación por WhatsApp.',
    },

    // --- Promo vertical (estilo "Promo Antójate", con frase y botón) ---
    {
      formato: 'vertical',
      nombre: '02-ejemplo-vertical',
      img: '1.jpg',
      kicker: 'Recién horneado',
      titulo: 'Antójate',
      frase: 'Babka de chocolate · Tuluá',   // cursiva bajo el título
      cta: 'Pedir ahora',                     // botón dorado; quita la línea si no quieres
    },
  ],
};
// ----------------------------------------------------
